...
public class JCard extends card {
     ...
     */
    public JCard(int rank, int suit, ImageIcon frontImage, ImageIcon backImage) {
        super(rank, suit);
     ...
     * @param backImage  image to display when card is face down
     */
    public JCard(int rank, int suit, String frontImage, String backImage) {
     ...
     * @param frontImage image to display when card is face up
     */
    public JCard(int rank, int suit, ImageIcon frontImage) {
     ...
     * @param frontImage image to display when card is face up
     */
    public JCard(int rank, int suit, String frontImage) {
     ...
     * @param suit of card
     */
    public JCard(int rank, int suit) {
    ...
    public JCard(card c) {
        this(c.value, c.s);
        //setFaceUp(c.isFaceUp());
    }

    private static String defaultImageName(int rank, int suit) {
